...
How simple! With regular expressions, one can remove unwanted punctuation, flip forename-surname order, correct semi-consistent errors, search for variant spellings at the same time, and much more in order to carry out more efficient and nuanced tidying or analysis.
